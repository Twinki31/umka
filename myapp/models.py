...
class User(models.Model):
    ...
    utm_source = models.CharField(_('Источник кампании'), max_length=255, null=True, blank=True)
    utm_medium = models.CharField(_('Тип трафика'), max_length=255, null=True, blank=True)
    utm_campaign = models.CharField(_('Название кампании'), max_length=255, null=True, blank=True)
    utm_content = models.CharField(_('Идентификатор объявления'), max_length=255, null=True, blank=True)
